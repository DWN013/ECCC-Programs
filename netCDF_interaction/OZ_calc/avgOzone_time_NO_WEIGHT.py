...
out_file = "avgOzoneCalc_TIME_NO_WEIGHT_Results.nc"
...
plt.ylabel('Latitude')
plt.savefig('OZ_NO_WEIGHT_origin_HARDCODE_WEIGHT.png')
print("OZ_NO_WEIGHT_origin_HARDCODE_WEIGHT.png generated")
...
plt.xlabel('Longitude')
plt.ylabel('Latitude')
plt.savefig('NO_WEIGHT_modified_HARDCODE_WEIGHT.png')
print("NO_WEIGHT_modified_HARDCODE_WEIGHT.png generated")