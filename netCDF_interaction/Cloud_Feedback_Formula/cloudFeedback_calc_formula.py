...
# Takes as input a .nc.999 file and runs a formula from the paper below on it to produce a result .nc file
...
# Tested and confirmed results of formula to correlate to control results on:
